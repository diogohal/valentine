...
def process_year_pair(year: int, matcher, sample_size: int = None) -> dict:
    year_next = year + 1
    ...
    matches_filename = OUTPUT_DIR / f"matches_escola_total_{year}_{year_next}_{algo_name}.csv"
...
def main():
    ...
    for sample_size in sample_sizes:
        ...
        for year in range(START_YEAR, END_YEAR + 1):
            row = process_year_pair(year, matcher)
